...
/**
 * Created by fzy on 2017/11/2.
 */
@Component("defaultAlarmCenter")
public class DefaultAlarmCenter extends IAlarmCenter {
    //protected String alarmId;
    //protected AlarmTemplate alarmTemplate;
    //protected int lastIndex = 0;
    protected String alarmId = ConstantUtils.DEFAULT_WARING_ID;

    protected List<Alarm> alarms = new ArrayList<Alarm>();
    protected AlarmTemplate alarmTemplate = new AlarmTemplate(
            ConstantUtils.DEFAULT_WARING_ID,
            ConstantUtils.DEFAULT_WARING_TITLE,
            ConstantUtils.DEFAULT_WARING_FORMAT
    );
